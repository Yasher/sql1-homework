...
<ins>
SELECT CAST ( p.payment_date  AS DATE ) ddd FROM sakila.payment p; </ins>
<ins>SQL Error [1584] [42000]: Incorrect parameters in the call to stored function `CAST` </ins>
<ins>CAST Не работает Почему?</ins>
